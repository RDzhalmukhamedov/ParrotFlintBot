...
namespace ParrotFlintBot.DB.Migrations
{
    ...
    [Migration("20230604152214_AddedProxyListToAppSettings")]
    partial class AddedProxyListToAppSettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ParrotFlintBot.Domain.AppSettings", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateOfLastCrawl = new DateTime(2023, 6, 4, 15, 22, 14, 500, DateTimeKind.Utc).AddTicks(2938)
                        });
                });
