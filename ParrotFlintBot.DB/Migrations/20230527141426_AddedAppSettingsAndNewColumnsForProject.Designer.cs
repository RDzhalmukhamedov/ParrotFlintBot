...
namespace ParrotFlintBot.DB.Migrations
{
    ...
    [Migration("20230527141426_AddedAppSettingsAndNewColumnsForProject")]
    partial class AddedAppSettingsAndNewColumnsForProject
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ParrotFlintBot.Domain.AppSettings", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateOfLastCrawl = new DateTime(2023, 5, 17, 14, 14, 26, 317, DateTimeKind.Utc).AddTicks(4007)
                        });
                });
