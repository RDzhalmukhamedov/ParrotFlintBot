...
public class CommunicationService : ICommunicationService
{
    ...
    public async Task<Message> RequestProjectsList(Message message, CancellationToken stoppingToken)
    {
        ...
        _publisher.PushMessage(_routeKey,new UserActionInfo { ChatId = message.Chat.Id, UserId = message.Chat.Username!, ProjectLink = null, Type = UserActionType.List }, _config.MessageTTL);
